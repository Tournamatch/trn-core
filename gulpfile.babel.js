...
export const styles = () => {
  return src(['src/scss/brackets.scss', 'src/scss/components.scss', 'src/scss/online-statistics-widget.scss', 'src/scss/trn.datatable.bootstrap4.css', 'src/scss/fontawesome.5.14.0.css', 'src/scss/admin.scss'])
