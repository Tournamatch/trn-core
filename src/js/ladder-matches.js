            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (options.user_capability) {
                        ...
                        links.push(`<a class="trn-confirm-action-link trn-delete-match-action" data-match-id="${row.match_id}" data-confirm-title="${options.language.delete_match}" data-confirm-message="${options.language.delete_confirm.format(row.match_id)}" data-modal-id="delete-match" href="#" title="${options.language.delete_match}"><i class="fa fa-times"></i></a>`);
                    }
