<?php
/**
 * Defines the business rule that prohibits removing the rank of the team owner rank.
 *
 ...
 */
class Cannot_Remove_Owner_Rank implements Business_Rule {
	...
	public function failure_message() {
		return esc_html__( 'You may not remove the rank of the team owner rank.', 'tournamatch' );
	}
}
